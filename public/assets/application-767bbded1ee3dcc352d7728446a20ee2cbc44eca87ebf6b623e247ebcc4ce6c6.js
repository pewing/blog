...
( function ( $, window, document, undefined ) {
    ...
    function makeCSS( node ) {
        var centeredX = node.x - $( window ).width() / 2,
            centeredY = node.y - $( window ).height() * 0.4,
            style = {};
    ...
    /* Determine the app prefix of the visitor's browser,
     http://lea.verou.me/2009/02/find-the-app-prefix-of-the-current-browser/
     */
...
$('.pages.about').ready(function() {
    ...
    $.fn.scrollPath("getPath", {
        ...
        // Line to 'rotations'
        .lineTo(2400, 750, {name: "about-anything-else"})
    ...
    // TODO: Scrolling works with mouse, not apple pad
